...
publicControllers.controller('LostPasswordController', ['$scope', '$window', 'Principal', 'UserFunction', 'Otp', 'UserPrincipal', 'Session','UserVerifiedPrincipal', 'global', '$sce',
  function($scope, $window, Principal, UserFunction, Otp, UserPrincipal, Session, UserVerifiedPrincipal, global, $sce) {
	...
	$scope.logIn = function() {
		...
		//$window.location.href = $window.APP_ROOT + '#/authentication';
	};
